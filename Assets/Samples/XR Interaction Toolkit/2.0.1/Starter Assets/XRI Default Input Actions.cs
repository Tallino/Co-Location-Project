...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Synchronize"",
            ""id"": ""22e92575-de62-471a-8d7c-8b26f0a937de"",
            ""actions"": [
                {
                    ""name"": ""SendData"",
                    ""type"": ""Button"",
                    ""id"": ""7cbaae76-1813-4b1d-8dfb-97e702a7e810"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
    ...
    // Synchronize
    private readonly InputActionMap m_Synchronize;
    private ISynchronizeActions m_SynchronizeActionsCallbackInterface;
    private readonly InputAction m_Synchronize_SendData;
    public struct SynchronizeActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        public SynchronizeActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @SendData => m_Wrapper.m_Synchronize_SendData;
        public InputActionMap Get() { return m_Wrapper.m_Synchronize; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(SynchronizeActions set) { return set.Get(); }
        public void SetCallbacks(ISynchronizeActions instance)
        {
            if (m_Wrapper.m_SynchronizeActionsCallbackInterface != null)
            {
                @SendData.started -= m_Wrapper.m_SynchronizeActionsCallbackInterface.OnSendData;
                @SendData.performed -= m_Wrapper.m_SynchronizeActionsCallbackInterface.OnSendData;
                @SendData.canceled -= m_Wrapper.m_SynchronizeActionsCallbackInterface.OnSendData;
            }
            m_Wrapper.m_SynchronizeActionsCallbackInterface = instance;
            if (instance != null)
            {
                @SendData.started += instance.OnSendData;
                @SendData.performed += instance.OnSendData;
                @SendData.canceled += instance.OnSendData;
            }
        }
    }
